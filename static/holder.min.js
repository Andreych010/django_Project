...
!function (e) {
    ...
    return function (e) {
        ...
        (function (t) {
            ...
            function a(e) {
                var t = e.mode, n = e.el, r = e.flags, i = e.engineSettings, a = r.dimensions, s = r.theme,
                ...
                var b = {mode: t, el: n, holderSettings: {dimensions: a, theme: s, flags: r}, engineSettings: v};
            ...
            function o(e) {
                ...
                var r = null, i = e.mode, a = e.el, o = e.holderSettings, l = e.engineSettings;
                switch (l.renderer) {
                    case"svg":
                ...
                var h = {width: o.dimensions.width, height: o.dimensions.height, theme: o.theme, flags: o.flags},
                    u = s(h);
                if (r = n(), null == r) throw"Holder: couldn't render placeholder";
                "background" == i ? (a.style.backgroundImage = "url(" + r + ")", l.noBackgroundSize || (a.style.backgroundSize = h.width + "px " + h.height + "px")) : ("img" === a.nodeName.toLowerCase() ? x.setAttr(a, {src: r}) : "object" === a.nodeName.toLowerCase() && x.setAttr(a, {
                    data: r,
                    type: "image/svg+xml"
                }), l.reRender && t.setTimeout(function () {
                    var e = n();
                    if (null == e) throw"Holder: couldn't render placeholder";
                    "img" === a.nodeName.toLowerCase() ? x.setAttr(a, {src: e}) : "object" === a.nodeName.toLowerCase() && x.setAttr(a, {
                        data: e,
                        type: "image/svg+xml"
                    })
                }, 150)), x.setAttr(a, {"data-holder-rendered": !0})
            }
            ...
            function s(e) {
                ...
                var r = e.flags.lineWrap || O.setup.lineWrapRatio, i = e.width * r, a = i,
                    o = new y({width: e.width, height: e.height}), s = o.Shape,
            ...
            function l(e, t, n, r) {
                var i = parseInt(e, 10), a = parseInt(t, 10), o = Math.max(i, a), s = Math.min(i, a),
                    l = .8 * Math.min(s, o * r);
            ...
            function h(e) {
                ...
                for (var n = 0, r = t.length; r > n; n++) {
                    var i = t[n];
                    if (i.holderData) {
                        var a = i.holderData.flags, s = k(i);
                        if (s) {
            ...
            var m = n(2), v = n(3), y = n(6), w = n(7), b = n(8), x = n(9), S = n(10), A = n(11), C = n(12), E = n(15),
                T = w.extend, k = w.dimensionCheck, F = A.svg_ns, j = {
                    version: A.version, addTheme: function (e, t) {
                        ...
                        var s = x.getNodeArray(o.images), l = x.getNodeArray(o.bgnodes), h = x.getNodeArray(o.stylenodes),
                        ...
                        return n.stylesheets = [], n.svgXMLStylesheet = !0, n.noFontFallback = !!o.noFontFallback, n.noBackgroundSize = !!o.noBackgroundSize, h.forEach(function (e) {
                            ...
                            if (t.getComputedStyle) {
                                var r = t.getComputedStyle(e, null).getPropertyValue("background-image"),
                                    s = e.getAttribute("data-background-src"), l = s || r, h = null, u = o.domain + "/",
                                    d = l.indexOf(u);
                                ...
                                if (h) {
                                    var f = i(h, o);
                                    f && a({mode: "background", el: e, flags: f, engineSettings: n})
                                }
                            }
                            ...
                            var a = null != t.src, s = null != t.dataSrc && 0 === t.dataSrc.indexOf(o.domain),
                    ...
                    return function (r) {
                        ...
                        if (O.setup.supportsSVG) {
                            ...
                            (null == e || e.parentNode !== document.body) && (a = !0), e = b.initSVG(e, i.properties.width, i.properties.height), e.style.display = "block", a && (t = x.newEl("text", F), n = o(null), x.setAttr(t, {x: 0}), t.appendChild(n), e.appendChild(t), document.body.appendChild(e), e.style.visibility = "hidden", e.style.position = "absolute", e.style.top = "-100%", e.style.left = "-100%");
                            ...
                            var u = t.getBBox(), d = Math.ceil(u.width / i.properties.width), c = l.text.split(" "),
                                f = l.text.match(/\\n/g);
                            d += null == f ? 0 : f.length, n.nodeValue = l.text.replace(/[ ]+/g, "");
                            var p = t.getComputedTextLength(), g = u.width - p,
                                m = Math.round(g / Math.max(1, c.length - 1)), v = [];
                            if (d > 1) {
                                n.nodeValue = "";
                                for (var y = 0; y < c.length; y++) if (0 !== c[y].length) {
                                    n.nodeValue = w.decodeHtmlEntity(c[y]);
                                    var S = t.getBBox();
                                    v.push({text: c[y], width: S.width})
                                }
                            }
                            return e.style.display = "none", {spaceWidth: m, lineCount: d, boundingBox: u, words: v}
                        }
                        return !1
                    }
                }();
        ...
        function n(e) {
            ...
            var o = e.document, s = o.documentElement, l = "load", h = !1, u = "on" + l, d = "complete",
                c = "readyState", f = "attachEvent", p = "detachEvent", g = "addEventListener", m = "DOMContentLoaded",
                v = "onreadystatechange", y = "removeEventListener", w = g in o, b = h, x = h, S = [];
        ...
        var r = encodeURIComponent, i = decodeURIComponent, a = n(4), o = n(5), s = /(\w+)\[(\d+)\]/, l = /\w+\.\w+/;
        t.parse = function (e) {
            ...
            for (var t = {}, n = e.split("&"), r = 0; r < n.length; r++) {
                ...
                if (o = s.exec(c)) t[o[1]] = t[o[1]] || [], t[o[1]][o[2]] = i(d[1]); else if (o = l.test(c)) {
                    for (o = c.split("."), h = t; o.length;) if (u = o.shift(), u.length) {
                        if (h[u]) {
            ...
            for (var n in e) {
                var i = e[n];
                if ("array" != o(i)) t.push(r(n) + "=" + r(e[n])); else for (var a = 0; a < i.length; ++a) t.push(r(n + "[" + a + "]") + "=" + r(i[a]))
            }
            return t.join("&")
        }
    }, function (e, t) {
        ...
        var n = function (e) {
            ...
            l.prototype = new a;
            var h = new i;
            return this.Shape = {Rect: s, Text: l, Group: o}, this.root = h, this
        };
        e.exports = n
    }, function (e, t) {
        (function (e) {
            t.extend = function (e, t) {
                ...
                var t, n = /(^(?:#?)[0-9a-f]{6}$)|(^(?:#?)[0-9a-f]{3}$)/i,
                    ...
                    i = /^rgba\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(0*\.\d{1,}|1)\)$/, a = e.match(n);
        ...
        (function (e) {
            var r = n(9), i = "http://www.w3.org/2000/svg", a = 8;
            t.initSVG = function (e, t, n) {
                var o, s, l = !1;
                e && e.querySelector ? (s = e.querySelector("style"), null === s && (l = !0)) : (e = r.newEl("svg", i), l = !0), l && (o = r.newEl("defs", i), s = r.newEl("style", i), r.setAttr(s, {type: "text/css"}), o.appendChild(s), e.appendChild(o)), e.webkitMatchesSelector && e.setAttribute("xmlns", i);
                ...
                if (e.XMLSerializer) {
                    var i = new XMLSerializer, a = "", o = n.stylesheets;
        ...
        n.rgb2hex = function (e, t, n) {
            ...
            var r = e / 60, i = (1 - Math.abs(2 * n - 1)) * t, a = i * (1 - Math.abs(parseInt(r) % 2 - 1)),
                o = n - i / 2, s = 0, l = 0, h = 0;
            ...
            var t = (16711680 & this.raw) >> 16, n = (65280 & this.raw) >> 8, r = 255 & this.raw,
                i = .2126 * t + .7152 * n + .0722 * r, a = -.09991 * t - .33609 * n + .436 * r,
                o = .615 * t - .55861 * n - .05639 * r;
            return this.rgb = {r: t, g: n, b: r}, this.yuv = {y: i, u: a, v: o}, this
        }, n.prototype.lighten = function (e) {
            var t = Math.min(1, Math.max(0, Math.abs(e))) * (0 > e ? -1 : 1), r = 255 * t | 0,
                i = Math.min(255, Math.max(0, this.rgb.r + r)), a = Math.min(255, Math.max(0, this.rgb.g + r)),
                o = Math.min(255, Math.max(0, this.rgb.b + r)), s = n.rgb2hex(i, a, o);
            return new n(s)
            ...
            var t = e, r = this, i = t.alpha * t.rgb.r + (1 - t.alpha) * r.rgb.r,
                a = t.alpha * t.rgb.g + (1 - t.alpha) * r.rgb.g, o = t.alpha * t.rgb.b + (1 - t.alpha) * r.rgb.b;
        ...
        var o = n(13), s = n(8), l = n(11), h = n(7), u = l.svg_ns, d = {
            element: function (e) {
            ...
            Object.keys(p.children).forEach(function (e) {
                ...
                Object.keys(t.children).forEach(function (e) {
                    var n = t.children[e], r = p.x + t.x + n.x, i = p.y + t.y + n.y,
                        a = d.element({tag: "text", content: n.properties.text, x: r, y: i});
                    m.push(a)
                })
            });
        ...
        e.exports = function r(e, t, n) {
            ...
            function i(e) {
                var t = e.match(/^[\w-]+/), r = {tag: t ? t[0] : "div", attr: {}, children: []},
                    i = e.match(/#([\w-]+)/), a = e.match(/\$([\w-]+)/), o = e.match(/\.[\w-]+/g);
        ...
        e.exports = function () {
            ...
            return function (n) {
                ...
                var r = i.canvasRatio(), a = n.root;
                e.width = r * a.properties.width, e.height = r * a.properties.height, t.textBaseline = "middle";
                var o = a.children.holderBg, s = r * o.width, l = r * o.height, h = 2, u = h / 2;
